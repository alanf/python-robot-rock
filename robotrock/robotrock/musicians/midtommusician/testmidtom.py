...
''' testmidtom.py
    Unit Tests for the MidTom
    Author: Rich Snider <mrsoviet@cs.washington.edu>
'''

import sys
import unittest
from midtom import MidTom
sys.path.append('../..')
import note

# This is the test suite for the MidTom
class TestMidTom(unittest.TestCase):
    ...
    # Tests that the MidTom reacts appropriately to changes in energy and
