...
# This is the definition of a MidTom
class MidTom(MusicianStructured):

    # Initialization of a MidTom. Initializes MidTom specific values and
    ...
    def __init__(self, energy=50, complexity=50, time = (4,4), key = ('B', 'major')):
        ...
        self.instrument = 'mid tom'
        self._my_tone=DrumKit["Low-Mid Tom"]
    ...
    # For a MidTom, this is done by playing mainly on-beat notes (as able)
    ...
    #   MidTom, a note should run into the next note and be no more than
...
# Returns the construtor for the MidTom		
def Musician():
    return MidTom()
