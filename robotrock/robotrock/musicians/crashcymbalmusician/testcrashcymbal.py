...
''' testcrashcymbal.py
    Unit Tests for the CrashCymbal
    Author: Rich Snider <mrsoviet@cs.washington.edu>
'''

import sys
import unittest
from crashcymbal import CrashCymbal
sys.path.append('../..')
import note

# This is the test suite for the CrashCymbal
class TestCrashCymbal(unittest.TestCase):
    ...
    # Tests that the CrashCymbal reacts appropriately to changes in energy and
