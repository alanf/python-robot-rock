...
# This is the definition of a SnareDrum
class SnareDrum(MusicianStructured):

    # Initialization of a SnareDrum. Initializes SnareDrum specific values and
    ...
    def __init__(self, energy=50, complexity=50, time = (4,4), key = ('B', 'major')):
        ...
        self.instrument = 'snare drum'
        self._my_tone=DrumKit["Acoustic Snare"]
    ...
    # For a SnareDrum, this is done by playing mainly on-beat notes (as able)
    ...
    #   SnareDrum, a note should run into the next note and be no more than
    ...
    def _onbeat(self):
        ...
        for x in range(self._time[0]):
            ...
            if self._complexity < 30 and self._notes >= self._time[0] - x:
