...
# This is the test suite for the SnareDrum
class TestSnaredrum(unittest.TestCase):
    ...
    # Tests that the SnareDrum reacts appropriately to changes in energy and
