...
# This is the definition of a HighTom
class HighTom(MusicianStructured):

    # Initialization of a HighTom. Initializes HighTom specific values and
    ...
    def __init__(self, energy=50, complexity=50, time = (4,4), key = ('B', 'major')):
        ...
        self.instrument = 'high tom'
        self._my_tone=DrumKit["Hi-Mid Tom"]
    ...
    # For a HighTom, this is done by playing mainly on-beat notes (as able)
    ...
    #   HighTom, a note should run into the next note and be no more than
...
# Returns the construtor for the HighTom		
def Musician():
    return HighTom()
