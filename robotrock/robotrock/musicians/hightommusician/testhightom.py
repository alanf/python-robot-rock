...
''' testhightom.py
    Unit Tests for the HighTom
    Author: Rich Snider <mrsoviet@cs.washington.edu>
'''

import sys
import unittest
from hightom import HighTom
sys.path.append('../..')
import note

# This is the test suite for the HighTom
class TestHighTom(unittest.TestCase):
    ...
    # Tests that the HighTom reacts appropriately to changes in energy and
