...
''' testfloortom.py
    Unit Tests for the FloorTom
    Author: Rich Snider <mrsoviet@cs.washington.edu>
'''

import sys
import unittest
from floortom import FloorTom
sys.path.append('../..')
import note

# This is the test suite for the FloorTom
class TestFloorTom(unittest.TestCase):
    ...
    # Tests that the FloorTom reacts appropriately to changes in energy and
