...
''' testacousticguitar2.py
    Unit Tests for the AcousticGuitar2
    Author: Rich Snider <mrsoviet@cs.washington.edu>
'''

import sys
import unittest
from acousticguitar2 import AcousticGuitar2
sys.path.append('../..')
import note
import chords

# This is the test suite for the AcousticGuitar2
class TestAcousticGuitar2(unittest.TestCase):
    ...
    # Tests that the AcousticGuitar2 reacts appropriately to changes in energy and
    ...
    def testProgressions(self):
        self.guitar = AcousticGuitar2(energy = 80, complexity = 80)
