...
''' testwoodblock.py
    Unit Tests for the WoodBlock
    Author: Rich Snider <mrsoviet@cs.washington.edu>
'''

import sys
import unittest
from woodblock import WoodBlock
sys.path.append('../..')
import note

# This is the test suite for the WoodBlock
class TestWoodBlock(unittest.TestCase):
    ...
    # Tests that the WoodBlock reacts appropriately to changes in energy and
