...
''' testridecymbal.py
    Unit Tests for the RideCymbal
    Author: Rich Snider <mrsoviet@cs.washington.edu>
'''

import sys
import unittest
from ridecymbal import RideCymbal
sys.path.append('../..')
import note

# This is the test suite for the RideCymbal
class TestRideCymbal(unittest.TestCase):
    ...
    # Tests that the RideCymbal reacts appropriately to changes in energy and
